...
const Profile = (props) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-gray-900 w-full overflow-x-hidden">
              ...
              <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                <div className="flex space-x-2">
                  <a
                    ...
                    href="https://www.github.com/rahul7011"
                    rel="noopener"
                    aria-label="Rahul Maurya on Github"
                    target="_blank"
                  >
                    <svg
                  ...
                  <a
                    ...
                    href={info?.blog}
                    rel="noopener"
                    aria-label="Rahul Maurya on Linkedin"
                    target="_blank"
                  >
                    <svg
                      className="w-6 h-6 overflow-visible fill-current"
